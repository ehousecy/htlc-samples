...
let senderAccount = "asender"
let senderPasswd = "qwe"
let receiverAccount = "areceiver"
let receiverPasswd = "qwe"
...
async function lockFabricAssets() {
  ...
  let res = await createHTLC(senderAccount, receiverAccount, "10", (expireDuration * 1.5 ).toString(), hashLock, senderPasswd, midAccount)
